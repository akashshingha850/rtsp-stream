...
while true; do
	...
	detectnet --output-save=media/output_$(date +"%Y%m%d_%H%M%S").mp4 --ssl-key=key.pem --ssl-cert=cert.pem rtsp://192.168.144.108:554/live webrtc://192.168.192.100:8556/output || true
